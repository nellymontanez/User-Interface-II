...
-x implement a CSS reset and understand why it’s important for cross-browser development
-x identify and explain all properties in the box model
-x describe and understand that flexbox is a module
